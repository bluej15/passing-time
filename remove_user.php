...
$result = $mysqli->query("DELETE FROM jperina_final_people WHERE id={$rowId}");
			...
			<div id="" class="form_container">
				...
				<div id="" class="form_content">
					<?php if (!empty($mysqli->error)) : ?>
						<h2>Errors:</h2>
						<p>
							This code triggered the following error:
					...
					<?php if ($mysqli->affected_rows > 0) : ?>
						<p>
							Success!  
							You removed <?php echo $mysqli->affected_rows; ?> teacher.
						</p>
					<?php else : ?>
						<p>
